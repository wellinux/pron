...
Exame.create(:exame_category_id=>3,:nome=>"Isento de Exames Complementares")
Exame.create(:exame_category_id=>3,:nome=>"Hemograma Completo")
Exame.create(:exame_category_id=>3,:nome=>"Colinesterase Plasmática")
Exame.create(:exame_category_id=>3,:nome=>"Sumário de Urina")
Exame.create(:exame_category_id=>3,:nome=>"Parasitológico de Fezes")
Exame.create(:exame_category_id=>3,:nome=>"Glicemia de Jejum")
Exame.create(:exame_category_id=>3,:nome=>"Contagem de Plaquetas")
Exame.create(:exame_category_id=>3,:nome=>"Colesterol Total")
Exame.create(:exame_category_id=>3,:nome=>"HDL Colesterol")
Exame.create(:exame_category_id=>3,:nome=>"LDL Colesterol")
Exame.create(:exame_category_id=>3,:nome=>"Triglicerídeos")
Exame.create(:exame_category_id=>3,:nome=>"HB Glicosada")
Exame.create(:exame_category_id=>3,:nome=>"Ácido Úrico")
Exame.create(:exame_category_id=>3,:nome=>"Uréia")
Exame.create(:exame_category_id=>3,:nome=>"Creatinina Sérica")
Exame.create(:exame_category_id=>3,:nome=>"Fosfatase Alcalina")
Exame.create(:exame_category_id=>3,:nome=>"Bilirrubinas")
Exame.create(:exame_category_id=>3,:nome=>"TGO")
Exame.create(:exame_category_id=>3,:nome=>"TGP")
Exame.create(:exame_category_id=>3,:nome=>"Urocultura c/ Antibiograma")
Exame.create(:exame_category_id=>3,:nome=>"Prova de Atividades Reumáticas")
Exame.create(:exame_category_id=>3,:nome=>"PSA Total")
Exame.create(:exame_category_id=>3,:nome=>"Metahemoglobina urina/sangue")
Exame.create(:exame_category_id=>3,:nome=>"Zincoprotoporfirina")
Exame.create(:exame_category_id=>3,:nome=>"Chumbo na urina")
Exame.create(:exame_category_id=>3,:nome=>"Cromo urina")
Exame.create(:exame_category_id=>3,:nome=>"Carboxihemoglobina no Sangue")
Exame.create(:exame_category_id=>3,:nome=>"Acido Mandélico na urina")
Exame.create(:exame_category_id=>3,:nome=>"Fenol na urina")
Exame.create(:exame_category_id=>3,:nome=>"Fluoreto na Urina")
Exame.create(:exame_category_id=>3,:nome=>"Mercúrio na Urina")
Exame.create(:exame_category_id=>3,:nome=>"Metahemoglobina no sangue")
Exame.create(:exame_category_id=>3,:nome=>"Acido Hipurico na urina")
Exame.create(:exame_category_id=>3,:nome=>"Acidometilhipurico na urina")